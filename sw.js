const CACHE_NAME = 'sec-hacienda-v4';
const APP_SHELL = ['./', './index.html', './app.js', './styles.css', './js/assets.js', './js/identidad.js', './css/identidad.css', './js/configuracion.js', './css/configuracion.css', './manifest.webmanifest'];
...
const CACHE_ARCHIVOS = 'sec-hacienda-archivos-v1';
