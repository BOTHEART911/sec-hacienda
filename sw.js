const CACHE_NAME = 'sec-hacienda-v28';
const APP_SHELL = ['./', './index.html', './app.js', './styles.css', './js/assets.js', './js/identidad.js', './css/identidad.css', './js/configuracion.js', './css/configuracion.css', './js/base-visual.js', './css/base-visual.css', './js/capa-12-antidoble.js', './js/en-vivo.js', './js/alcance.js', './js/descargas.js', './css/descargas.css', './css/vistas.css', './js/visor.js', './css/visor.css', './js/esqueletos.js', './js/capa-11-insights.js', './css/capa-11-insights.css', './js/fechas-ios.js', './css/fechas-ios.css', './js/asignador.js', './css/asignador.css', './js/asistente.js', './js/bitacora.js', './css/bitacora.css', './js/adjuntos.js', './js/bdp-rapido.js', './js/no-aperturados.js', './js/form-ancho.js', './css/form-ancho.css', './js/bitacora-export.js', './css/bitacora-export.css', './js/mi-trabajo.js', './css/mi-trabajo.css', './js/solicitud-exp.js', './css/solicitud-exp.css', './manifest.webmanifest'];
