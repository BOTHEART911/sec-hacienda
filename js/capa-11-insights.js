...
(function () {
  ...
  var PANELES = {
    ...
    'view-estadisticas': {
      ...
      botones: [
        { id: 'resumen',   et: 'Resumen del año',    ic: '📊' },
    ...
    'view-panel': {
      ...
      botones: [
        { id: 'resumen',   et: 'Resumen y semáforo', ic: '📊' },
    ...
    'view-bdp-panel': {
      ...
      botones: [
        { id: 'resumen',   et: 'Resumen de cartera', ic: '💰' },
  ...
  function abrir(vista) {
    ...
    pedirVoz();
    pintarAviso(body, 'Toca una consulta abajo. Los números salen de lo que tienes en pantalla ahora mismo, con los filtros puestos.');
    var primero = pie.querySelector('.iq-chip');
    if (primero) primero.classList.add('on');
    lanzar(body, vista, cfg.botones[0]);
  }
