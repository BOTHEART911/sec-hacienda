const CACHE_NAME = 'sec-hacienda-v6';
const APP_SHELL = ['./', './index.html', './app.js', './styles.css', './js/assets.js', './js/identidad.js', './css/identidad.css', './js/configuracion.js', './css/configuracion.css', './js/base-visual.js', './css/base-visual.css', './js/capa-12-antidoble.js', './js/en-vivo.js', './manifest.webmanifest'];
