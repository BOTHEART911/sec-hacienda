  ...
  return (
    '<div class="bdp-card clasif-' + clasif + '" data-bdp-idx="' + idx + '">' +
      ...
      '<div class="bdp-grid">' +
        ...
        /* AJUSTE 10/09 — el correo va en su propia fila a todo el ancho y en
           UNA sola línea (se recorta con "…"): así la tarjeta mide igual con
           correo corto, con uno larguísimo o sin correo. */
        '<div class="bdp-cell-correo"><b>Correo electrónico</b>' +
          (correoTxt
