  ...
  function modalUsuario_(u) {
    ...
    m.innerHTML =
      '<div class="cfg-modal-caja">' +
        ...
        '</label>' +
        '<label class="cfg-lbl">Carpeta Drive de anexos' +
          '<input id="cfgu-anexos" type="text" placeholder="Enlace de la carpeta" value="' + esc_(u ? u.carpetaAnexos : '') + '" />' +
        '</label>' +
        '<label class="cfg-lbl">Carpeta Drive de expedientes' +
          '<input id="cfgu-exp" type="text" placeholder="Enlace de la carpeta" value="' + esc_(u ? u.carpetaExpedientes : '') + '" />' +
        '</label>' +
