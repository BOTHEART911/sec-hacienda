  ...
  for (const it of items) {
    ...
    card.innerHTML = `
      ...
      <div class="cat-row">
        ...
        ${it.etapa ? `<span class="etapa-badge"><img src="img/subcategoria4-1.png" style="width:16px;height:16px;" alt=""> ${escapeHtml_(it.etapa)}</span>` : ''}
      </div>
    ...
    if (currentUser?.isSuper) {
      // Firmar
      const btnFirmar = makeIconBtn_('img/firma.webp', 'Firmar', async () => {
      ...
      // Eliminar
      const btnEliminar = makeIconBtn_('img/eliminar.webp', 'Eliminar', async () => {
    ...
    // Ver
    const btnVer = makeIconBtn_('img/mostrar.png', 'Ver', () => {
      __procSelected = it;
    ...
    if (currentUser?.isSuper || !estadoFinalizado) {
      const btnEditar = makeIconBtn_('img/editar.webp', 'Editar', () => {
        __procSelected = it;
